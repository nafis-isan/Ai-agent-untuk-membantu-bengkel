...
import { getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, shallowReactive, reactive, effectScope, hasInjectionContext, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, inject, defineAsyncComponent, mergeProps, defineComponent, withCtx, toRef, computed, shallowRef, h, isVNode, createCommentVNode, resolveComponent, isReadonly, createElementBlock, cloneVNode, isRef, toValue, toRaw, Suspense, nextTick, Fragment, useSSRContext, isShallow, isReactive, queuePostFlushCb } from 'vue';
import { f as createError, m as defu, n as klona, o as hasProtocol, i as joinURL, p as parseQuery, q as parseURL, e as encodePath, v as decodePath, w as defuFn, x as isScriptProtocol, y as withQuery, z as withTrailingSlash, A as withoutTrailingSlash, B as sanitizeStatusCode, $ as $fetch } from '../_/nitro.mjs';
...
var namedMiddleware = { auth: () => import('../build/auth-BaSBx0w4.mjs') };
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		path: "/appointments",
		meta: { layout: "default" },
		component: () => import('../build/appointments-BiBs1ySJ.mjs')
	},
	{
		name: "chat",
		path: "/chat",
		meta: { layout: "default" },
		component: () => import('../build/chat-BBjANi68.mjs')
	},
	{
		name: "customers",
		path: "/customers",
		meta: { layout: "default" },
		component: () => import('../build/customers-B3H98uN_.mjs')
	},
	{
		name: "login",
		path: "/login",
		meta: { layout: false },
		component: () => import('../build/login-DnLqFclH.mjs')
	},
	{
		name: "services",
		path: "/services",
		meta: { layout: "default" },
		component: () => import('../build/services-ppSykIFF.mjs')
	},
	{
		name: "spareparts",
		path: "/spareparts",
		meta: { layout: "default" },
		component: () => import('../build/spareparts-BJExG7Ki.mjs')
	},
	{
		name: "vehicles",
		path: "/vehicles",
		meta: { layout: "default" },
		component: () => import('../build/vehicles-Bv8I3cJ-.mjs')
	},
	{
		name: "index",
		path: "/",
...
var lazyGlobalComponents = [["Icon", defineAsyncComponent(() => import('../build/components-CGtk4XIN.mjs').then((n) => n.n).then((r) => r["default"] || r.default || r))]];
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import('../build/error-404-Bfw03QNk.mjs'));
		const _Error = defineAsyncComponent(() => import('../build/error-500-DoUXQ-oT.mjs'));
...
export { NuxtLink as N, useRoute$1 as a, useNuxtApp as b, useAppConfig as c, defineNuxtRouteMiddleware as d, useAsyncData as e, useHead$1 as f, entry as g, useRuntimeConfig as u };
