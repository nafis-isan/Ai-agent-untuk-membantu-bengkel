import { a as useNuxtApp, c as fetchDefaults, d as appDiagnostics, f as docsBase, i as definePayloadPlugin, l as nuxtLinkDefaults, n as createNuxtApp, o as useRuntimeConfig, p as prodReporters, r as defineNuxtPlugin, s as asyncDataDefaults, t as applyPlugins } from "./_nuxt/nuxt-Bdrh30cM.js";
import { defineProdDiagnostics } from "nostics";
import { Fragment, Suspense, cloneVNode, computed, createApp, createCommentVNode, createElementBlock, createVNode, defineAsyncComponent, defineComponent, getCurrentInstance, getCurrentScope, h, hasInjectionContext, inject, isReactive, isReadonly, isRef, isShallow, isVNode, mergeProps, nextTick, onErrorCaptured, onServerPrefetch, provide, queuePostFlushCb, reactive, ref, resolveComponent, resolveDynamicComponent, shallowReactive, shallowRef, toRaw, toRef, toValue, unref, useSSRContext, withCtx } from "vue";
import { executeAsync } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/unctx/dist/index.mjs";
import { createError, sanitizeStatusCode } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/@nuxt/nitro-server/dist/h3.mjs";
import { decodePath, encodePath, hasProtocol, isScriptProtocol, joinURL, parseQuery, parseURL, withQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/ufo/dist/index.mjs";
import { $fetch } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { headSymbol, useHead } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/@unhead/vue/dist/index.mjs";
import { defu, defuFn } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/defu/dist/defu.mjs";
import { RouterView, START_LOCATION, START_LOCATION as START_LOCATION$1, createMemoryHistory, createRouter, useRoute } from "vue-router";
import { isPlainObject } from "@vue/shared";
import { createPinia, setActivePinia, shouldHydrate } from "pinia";
import { klona } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/klona/dist/index.mjs";
import { fnv1a64Base36 } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/fnv1a-64/dist/index.mjs";
import { identify } from "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/object-identity/index.js";
import "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import "C:/Users/ADVAN/Videos/Ai-agent-untuk-membantu-bengkel/frontend/node_modules/ohash/dist/index.mjs";
...
var namedMiddleware = { auth: () => import("./_nuxt/auth-BaSBx0w4.js") };
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		path: "/appointments",
		meta: { layout: "default" },
		component: () => import("./_nuxt/appointments-BiBs1ySJ.js")
	},
	{
		name: "chat",
		path: "/chat",
		meta: { layout: "default" },
		component: () => import("./_nuxt/chat-BBjANi68.js")
	},
	{
		name: "customers",
		path: "/customers",
		meta: { layout: "default" },
		component: () => import("./_nuxt/customers-B3H98uN_.js")
	},
	{
		name: "login",
		path: "/login",
		meta: { layout: false },
		component: () => import("./_nuxt/login-DnLqFclH.js")
	},
	{
		name: "services",
		path: "/services",
		meta: { layout: "default" },
		component: () => import("./_nuxt/services-ppSykIFF.js")
	},
	{
		name: "spareparts",
		path: "/spareparts",
		meta: { layout: "default" },
		component: () => import("./_nuxt/spareparts-BJExG7Ki.js")
	},
	{
		name: "vehicles",
		path: "/vehicles",
		meta: { layout: "default" },
		component: () => import("./_nuxt/vehicles-Bv8I3cJ-.js")
	},
	{
		name: "index",
		path: "/",
		meta: { layout: "default" },
		component: () => import("./_nuxt/pages-DA4o-nlZ.js")
	}
];
//#endregion
...
var lazyGlobalComponents = [["Icon", defineAsyncComponent(() => import("./_nuxt/components-CGtk4XIN.js").then((n) => n.n).then((r) => r["default"] || r.default || r))]];
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import("./_nuxt/default-rFJtjPzs.js").then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Bfw03QNk.js"));
		const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DoUXQ-oT.js"));
...
//#endregion
export { defineNuxtRouteMiddleware as a, entry_default as default, useHead$1 as i, useAsyncData as n, navigateTo as o, useAppConfig as r, useRoute$1 as s, NuxtLink as t };
