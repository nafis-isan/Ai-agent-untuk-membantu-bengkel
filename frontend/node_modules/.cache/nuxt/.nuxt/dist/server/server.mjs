import { a as definePayloadPlugin, c as asyncDataDefaults, f as appDiagnostics, i as defineNuxtPlugin, l as fetchDefaults, m as prodReporters, n as applyPlugins, o as useNuxtApp, p as docsBase, r as createNuxtApp, s as useRuntimeConfig, t as useHead$1, u as nuxtLinkDefaults } from "./_nuxt/head-CdzMw8W1.js";
...
}, 1), /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {})];
var namedMiddleware = {};
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [
	{
		...
		path: "/chat",
		meta: { layout: "default" },
		component: () => import("./_nuxt/chat-BoJ3xdHv.js")
	},
	{
		name: "customers",
		path: "/customers",
		meta: { layout: "default" },
		component: () => import("./_nuxt/customers-kluaibOI.js")
	},
	{
		name: "services",
		path: "/services",
		meta: { layout: "default" },
		component: () => import("./_nuxt/services-1xwwtNWQ.js")
	},
	{
		name: "spareparts",
		path: "/spareparts",
		meta: { layout: "default" },
		component: () => import("./_nuxt/spareparts-CmmxHNf6.js")
	},
	{
		name: "vehicles",
		path: "/vehicles",
		meta: { layout: "default" },
		component: () => import("./_nuxt/vehicles-DD5IDuD0.js")
	},
	{
		name: "index",
		path: "/",
		meta: { layout: "default" },
		component: () => import("./_nuxt/pages-D5LkXngl.js")
	}
];
//#endregion
...
var lazyGlobalComponents = [["Icon", defineAsyncComponent(() => import("./_nuxt/components-Bfu6e32q.js").then((n) => n.n).then((r) => r["default"] || r.default || r))]];
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import("./_nuxt/default-R2SKe4yk.js").then((m) => m.default || m)) };
//#endregion
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DzdoIQIB.js"));
		const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cd1Lglox.js"));
...
//#endregion
export { entry_default as default, useRoute$1 as i, useAsyncData as n, useAppConfig as r, NuxtLink as t };
